...
export function StatsBentoSection() {
  return (
    <section className="bg-slate-50 py-24 px-6 dark:bg-background font-sans">
      <div className="mx-auto max-w-[1200px]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 auto-rows-[22rem]">
          ...
          <div className="group relative overflow-hidden rounded-4xl border border-border bg-card transition-all duration-500 hover:bg-primary-soft md:col-start-1 md:row-start-1 lg:col-start-1 lg:row-start-1">
            ...
            <div className="absolute inset-x-6 bottom-0 top-32 rounded-t-3xl border border-neutral-200/60 bg-white shadow-xl transition-transform duration-500 group-hover:-translate-y-2 dark:border-slate-700 dark:bg-slate-950">
              <div className="flex h-8 items-center gap-1.5 border-b border-neutral-100 bg-slate-50/50 px-3 dark:border-slate-800 dark:bg-slate-900/50">
          ...
          <div className="group relative overflow-hidden rounded-4xl border border-border bg-card transition-all duration-500 hover:bg-primary-soft md:col-start-1 md:row-start-2 lg:col-start-2 lg:row-start-1">
            ...
            <div className="absolute inset-x-6 bottom-[-20px] top-32 flex flex-col gap-2.5 transition-transform duration-500 group-hover:-translate-y-2">
              <div className="h-12 w-full rounded-2xl border border-neutral-200/60 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-950 flex items-center justify-between px-3 text-xs text-neutral-400">
          ...
          <div className="group relative overflow-hidden rounded-4xl border border-border bg-card transition-all duration-500 hover:bg-emerald-50/50 md:col-start-2 md:row-start-1 md:row-span-2 lg:col-start-3 lg:row-start-1 lg:row-span-2">
            ...
            <div className="absolute inset-x-6 bottom-0 top-36 rounded-t-2xl border-x-2 border-t-2 border-neutral-800 bg-white shadow-xl transition-transform duration-500 group-hover:-translate-y-2 dark:border-slate-600 dark:bg-black">
              <div className="flex flex-col gap-3 p-4 w-full">
                <div className="h-12 w-full rounded-2xl border border-neutral-200/60 bg-slate-50/50 dark:border-slate-800 dark:bg-slate-900 flex items-center justify-center text-xs text-neutral-400">
          ...
          <div className="group relative overflow-hidden rounded-4xl border border-border bg-card transition-all duration-500 hover:bg-slate-50/50 md:col-start-1 md:col-span-2 md:row-start-3 lg:col-start-1 lg:col-span-2 lg:row-start-2">
            ...
            <div className="absolute inset-x-6 md:left-[45%] lg:left-[50%] bottom-0 top-36 md:top-6 flex overflow-hidden rounded-t-2xl md:rounded-tl-2xl md:rounded-tr-none border border-neutral-200/60 bg-white shadow-xl transition-transform duration-500 group-hover:-translate-y-2 md:group-hover:-translate-x-2 md:group-hover:translate-y-0 dark:border-slate-700 dark:bg-slate-950">
              <div className="hidden sm:block w-1/3 border-r border-neutral-100 bg-slate-50/50 p-4 dark:border-slate-800 dark:bg-slate-900/30">
