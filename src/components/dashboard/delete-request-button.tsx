    ...
    return (
        <>
            <button
                ...
                disabled={isPending}
                className="flex-1 sm:flex-none bg-rose-50 border border-rose-100 hover:bg-rose-100 text-rose-600 px-8 py-3.5 rounded-[1.25rem] text-sm font-medium transition-colors disabled:opacity-50 cursor-pointer"
            >
