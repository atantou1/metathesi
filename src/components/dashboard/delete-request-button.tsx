    ...
    return (
        <>
            <button
                ...
                disabled={isPending}
                className="flex-1 sm:flex-none bg-white border border-slate-200 hover:bg-slate-50 text-slate-600 px-8 py-3.5 rounded-[1.25rem] text-sm font-medium transition-colors disabled:opacity-50 cursor-pointer"
            >
