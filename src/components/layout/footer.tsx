...
export function Footer() {
    return (
        <footer className="border-t border-border bg-white py-16 mt-auto">
            <div className="mx-auto max-w-7xl px-4 lg:px-0">
                <div className="grid grid-cols-1 gap-12 md:grid-cols-4">
                    <div className="col-span-1 md:col-span-2">
                        ...
                        <p className="max-w-sm text-text-tertiary leading-relaxed">
                ...
                <div className="mt-16 flex flex-col items-center justify-between gap-6 border-t border-border-dim pt-8 md:flex-row">
                    <p className="text-sm text-text-tertiary">
                        © 2024 metaThesi. Όλα τα δικαιώματα διατηρούνται.
                    </p>
                    <div className="flex gap-6">
                        <Link className="text-text-quaternary hover:text-primary" href="#" aria-label="Facebook">
                            <Facebook className="w-5 h-5" />
                        </Link>
                        <Link className="text-text-quaternary hover:text-primary" href="#" aria-label="X (Twitter)">
