...
4.  **Output & Communication:** Όταν βρεθεί αντιστοίχιση, το σύστημα ειδοποιεί τους εμπλεκόμενους χρήστες εντός της εφαρμογής αλλά και μέσω email (Resend). Η επικοινωνία γίνεται σε απομονωμένα Chat Rooms εντός της πλατφόρμας, αποκλειστικά για τους συμμετέχοντες του match.
