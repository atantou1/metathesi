...
4.  **Output:** Όταν βρεθεί αντιστοίχιση, το σύστημα ειδοποιεί τους εμπλεκόμενους χρήστες για να προχωρήσουν σε επικοινωνία. H ειδοποιήση γίνεται μέσω μηνυμάτων εντός της εφαρμογής αλλα και εκτός εφαρμογής μέσω email. Η Επικοινωνία των εμπλακομένων γίνεται εντός της εφαρμογής με μηνύματα.
